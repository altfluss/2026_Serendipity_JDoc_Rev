...
\begin{table}[t]
    \centering\small
    \caption{Representative tags at the five points A--E of
        $\mathcal{V}$: the top 5 annotated emotions,
        the top 5 painting features, and the top
        10 annotated words by pointwise
        mutual
        information (PMI, in bits, in parentheses). Negative PMI
        is omitted; PMI of at least 0.5 bit is in bold.
        Painting
