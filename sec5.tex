...
sound alone: we embed ten-second excerpts from across each track by
...
embeddings and the genre tags are all the modeling uses. The instrument, mood,
and theme tags stay held out, and read the space afterward.
...
Start with what the viewers felt (Figure~\ref{fig:wikiart}(c)). Each
painting is placed where its emotion leans, and drawn the more darkly
the stronger the leaning. Contentment and excitement hold the left,
fear and anger the upper right, sadness a blue band along the bottom.
The colours shade into each other, and feeling runs as one continuous
spectrum.
