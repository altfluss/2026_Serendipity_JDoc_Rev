...
\paragraph{Setup.}
The first library is built from MTG-Jamendo~\citep{Bogdanov2019}, an
...
sound alone: each track is embedded by CLAP~\citep{Wu2023}, a joint
...
CLIP~\citep{Radford20218748,Cherti20232818}, a joint image--text encoder, then
