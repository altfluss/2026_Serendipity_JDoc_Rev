...
\emph{connotative coordinate} $v$---where on it. That is, the pairing of
Section~\ref{subsec:serendipity_process}---denotatively unexpected,
connotatively relevant---now has an exact expression: distant in
$\mathcal{U}$, yet close in $\mathcal{V}$.
