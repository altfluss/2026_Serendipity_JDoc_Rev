...
distant in $\mathcal{U}$, yet close in $\mathcal{V}$.
...
\emph{genre-ness}, position rather than name, and it makes the stack
...
is simpler. It never had a label; Section~\ref{subsec:naming} found it
written in no field. Its coordinate $v$ is read
