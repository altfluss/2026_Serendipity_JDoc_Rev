...
distant in $\mathcal{U}$, and close in $\mathcal{V}$. A representation
...
%%% Subsection 3.2 Seeking Serendipity in the Library %%%%%a
...
coordinate system. The works are the same, threaded by the same holes; what
differs is whether the coordinates carry meaning. In the library they do: hold
one fixed, and what it names holds still, and the passage from floor to floor
runs straight. In the universe that meaning is spread across every axis at once,
and the same passage curves across the dark between galaxies. Straight in the
disentangled view, curved in the entangled one. To pass from the one view to the
other is to find that system.
