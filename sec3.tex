...
wants he can clearly name---a performer (Miles Davis), and with him a
genre (jazz) and a period (the 1950s and 60s)---and for that part, any
catalogue serves. The rest he could only
...
the same coordinate means the same connotation on every floor, spans
...
from the body data: the works themselves, and the words that circle
them.
